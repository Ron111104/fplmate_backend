"""
Django settings for fplmate_backend project.
...
SECRET_KEY = 'django-insecure-vrcu3!@k1ta9x=pr012*ozfbz0^v#pmqs!&7fj%-ywe5z2e8fq'
...
ROOT_URLCONF = 'fplmate_backend.urls'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",  # You can also add this as an additional origin
]
WSGI_APPLICATION = 'fplmate_backend.wsgi.application'
